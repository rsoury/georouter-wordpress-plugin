...
Web Doodle Terms of Service: [https://webdoodle.com.au/terms/?ref=georouter-wordpress-plugin](https://webdoodle.com.au/terms/?ref=georouter-wordpress-plugin)

https://georouter.services.webdoodle.com.au/ serves the script to facilitate the service's logic.

== Contributions ==

Feel free to submit any pull requests here: [https://github.com/rsoury/georouter-wordpress-plugin](https://github.com/rsoury/georouter-wordpress-plugin)
...
7.  Configure your "GeoRouter" settings. See below for details.

= Configure the plugin =
To configure the plugin, go to __WooCommerce > Settings__ from the left-hand menu, then click "GeoRouter" from the top tab menu.

* __Enable/Disable__ - check the box to enable GeoRouter.
* __Namespace__ - text input that accepts your GeoRouter namespace
* __Location__ - determine whether you want to load the script before </head> or before </body>